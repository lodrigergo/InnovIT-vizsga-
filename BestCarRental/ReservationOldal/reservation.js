document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("close-login-panel")
    .addEventListener("click", closeAllPanels);
  document
    .getElementById("close-register-panel")
    .addEventListener("click", closeAllPanels);
  ...
  document
    .getElementById("close-profile-panel")
    .addEventListener("click", function () {
      document.getElementById("profile-panel").classList.remove("open");
      document.getElementById("overlay").classList.remove("show");
    });
  ...
  document
    .querySelector(".register-panel .login-btn")
    .addEventListener("click", function () {
      document.getElementById("register-panel").classList.remove("open");
      document.getElementById("login-panel").classList.add("open");
    });
  ...
  document
    .querySelector("#login-panel .login-btn")
    .addEventListener("click", async function (e) {
      ...
      let emailError =
        document.getElementById("email").parentNode.querySelector("p") ||
        (function () {
      ...
      let passwordError =
        document.getElementById("password").parentNode.querySelector("p") ||
        (function () {
          let el = document.createElement("p");
          el.style.color = "red";
          el.style.fontSize = "14px";
      ...
      try {
        ...
        if (response.ok && data.status === "success") {
          ...
          if (
            ...
            !localStorage.getItem("reservationConfirmed")
          ) {
            document.querySelector(".login-section").innerHTML =
              "<h3>No vehicle reserved yet.</h3>";
          }
  ...
  document.querySelector(".logout-btn").addEventListener("click", function () {
    ...
    if (ls)
      ls.innerHTML =
        ls.getAttribute("data-original") || "<h3>No vehicle reserved yet.</h3>";
  ...
  // Regisztrációs input események: validáció
  ...
  document
    .querySelector(".register-create-account-btn")
    .addEventListener("click", async function (e) {
      e.preventDefault();
  ...
  if (
    ...
    document.querySelector(
      ".login-section"
    ).innerHTML = `<h3>${qty} foglalásod van <i class="fas fa-check-circle"></i></h3>`;
...
document
  ...
  .addEventListener("click", function () {
    ...
    if (document.querySelector(".login-section"))
      document.querySelector(".login-section").innerHTML =
        "<h3>1 foglalásod van <i class='fas fa-check-circle'></i></h3>";
    let selectedCarData = {
      image: document.querySelector(".car-info img").src || "",
      brand:
        document.querySelector(".car-info .details p:nth-child(1)")
          ?.textContent || "",
      model:
        document.querySelector(".car-info .details p:nth-child(2)")
          ?.textContent || "",
    };
...
function validateRegistration() {
  ...
  let usernameError =
    usernameInput.parentNode.querySelector("p") ||
    (function () {
      let el = document.createElement("p");
      el.style.color = "red";
      el.style.fontSize = "14px";
  ...
  let registerEmailError =
    registerEmailInput.parentNode.querySelector("p") ||
    (function () {
      let el = document.createElement("p");
      el.style.color = "red";
      el.style.fontSize = "14px";
  ...
  let registerPasswordError =
    registerPasswordInput.parentNode.querySelector("p") ||
    (function () {
      let el = document.createElement("p");
      el.style.color = "red";
      el.style.fontSize = "14px";
  ...
  let personalIdError =
    personalIdInput.parentNode.querySelector("p") ||
    (function () {
      let el = document.createElement("p");
      el.style.color = "red";
      el.style.fontSize = "14px";
